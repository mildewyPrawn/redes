...
\begin{center}
  \includegraphics[scale=.28]{edificioP.png}
\end{center}
...
\item Asignar direcciones de un \textit{segmento privado de clase B} a los
  ...
  \begin{itemize}
  \item Clase A: 10.0.0.0 a 10.255.255.255 
  \item Clase B: 172.16.0.0 a 172.31.255.255
  \item Clase C: 192.168.0.0 a 192.168.255.255
  \end{itemize}
